...
export const runCompetitors = (slug: string) =>
  dedupe(`competitors:${slug}`, () => cachedCompetitors(slug));

export const SECTION_IDS = ["what", "founders", "news", "competitors"] as const;
